...
import { Building, BarChart3, Zap, Shield, Users } from "lucide-react";
...
export default function AuthPage() {
  return (
    <div className="auth-page h-screen w-full overflow-hidden flex flex-col lg:flex-row relative" style={{ background: darkBg }}>
      ...
      <div className="lg:w-1/2 w-full flex flex-col justify-center px-6 lg:px-12 xl:px-16 py-8 relative shrink-0 z-10">
        <div className="relative z-10 w-full max-w-2xl">
          ...
          <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white leading-tight mb-3 font-jakarta auth-slide-up auth-delay-1 opacity-0" style={{ animationFillMode: "forwards" }}><span className="auth-text-glow inline-block">Welcome back</span></h2>
          <p className="text-slate-400 text-base mb-6 auth-slide-up auth-delay-2 opacity-0" style={{ animationFillMode: "forwards" }}>Email ya Username + Password se login karo. Owner, Admin ya Team member — sab ek hi jagah.</p>

          {/* Features Grid - Chhote function ko yahan call kar liya */}
