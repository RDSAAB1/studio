...
export default function DailySupplierReportClient() {
    ...
    const summary = useMemo(() => {
        return filteredSuppliers.reduce((acc, s) => {
            ...
            return acc;
        }, { gross: 0, tier: 0, total: 0, karta: 0, net: 0, labour: 0, kartaAmount: 0, kanta: 0, amount: 0, netAmount: 0 });
    }, [filteredSuppliers]);
                ...
                <Card>
                    <CardContent className="p-4 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="grid grid-cols-4 lg:grid-cols-6 gap-2 p-2 border rounded-lg bg-muted/50 items-center">
                                <SummaryBox label="Gross" value={summary.gross.toFixed(2)} />
                                <SummaryBox label="Tier" value={summary.tier.toFixed(2)} />
                                <SummaryBox label="Total" value={summary.total.toFixed(2)} />
                                <SummaryBox label="Karta" value={summary.karta.toFixed(2)} />
                                <SummaryBox label="Net" value={summary.net.toFixed(2)} />
                                <SummaryBox label="Amount" value={formatCurrency(summary.amount)} />
                            </div>
                        </div>
