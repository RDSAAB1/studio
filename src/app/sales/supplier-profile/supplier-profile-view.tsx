...
// import { Badge } from "@/components/ui/badge"; // --- DEBUG: Temporarily removed import ---
                ...
                <CardHeader>
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-2">
                        <div>
                            ...
                            {/* --- DEBUG: Added a heading to see if file updates --- */}
                            <h1>!!!---DID MY FILE UPDATE?---!!!</h1> 
                            <CardDescription>
                                        ...
                                        <TableBody>
                                            {(selectedSupplierData.allTransactions || []).map(entry => (
                                                <TableRow key={entry.id}>
                                                    ...
                                                    {/* --- DEBUG: Replaced Badge with a simple span to prevent crash --- */}
                                                    <TableCell>
                                                        <span>
