...
import { formatSrNo, toTitleCase, formatPaymentId } from "@/lib/utils";
...
import { Pen, Save, PlusCircle, Trash, Settings, X } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="parchiName">Parchi Name</Label>
                <Input id="parchiName" {...form.register("parchiName")} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="parchiAddress">Parchi Address</Label>
                <Input id="parchiAddress" {...form.register("parchiAddress")} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="acNo" {...form.register("acNo")} />
              </div>
              <div className="space-y-2">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Serial & Date Details</CardTitle>
            </CardHeader>
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="srNo">SR No.</Label>
                <Input id="srNo" {...form.register("srNo")} />
                {form.formState.errors.srNo && (
                  <p className="text-sm text-destructive">
                    {form.formState.errors.srNo.message}
                  </p>
                )}
                <Button type="button" onClick={generateSrNo} className="mt-2">
                  Generate SR No.
                </Button>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="grNo">6R No.</Label>
                <Input id="grNo" {...form.register("grNo")} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="grDate">6R Date</Label>
                <Input
                  type="date"
                  id="grDate"
              ...
              <div className="space-y-2">
                <Label htmlFor="parchiNo">Parchi No.</Label>
                <Input id="parchiNo" {...form.register("parchiNo")} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="parchiDate">Parchi Date</Label>
                <Input
                  type="date"
                  id="parchiDate"
                  {...form.register("parchiDate")}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="checkNo" {...form.register("checkNo")} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="utrNo">UTR No.</Label>
                <Input id="utrNo" {...form.register("utrNo")} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="rate">Rate</Label>
                <Input type="number" id="rate" {...form.register("rate")} />
              </div>
              <div className="space-y-2">
        ...
        <div className="flex justify-start space-x-4">
          <Button type="submit">
            {editingRecordIndex !== null ? (
              <>
                <Pen className="mr-2 h-4 w-4" /> Update Record
              </>
            ) : (
              <>
