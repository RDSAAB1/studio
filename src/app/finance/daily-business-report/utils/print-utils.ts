            ...
            <div class="section-card">
                ...
                ${(() => {
                    ...
                    const groups = {
                        ...
                        'Gov':    { rows: allRows.filter((r: any) => r.paymentMethod === 'Cheque' || r.paymentMethod === 'Gov.' || r.paymentMethod === 'Gov' || r.paymentMethod === 'Gov Dist').sort(sortById), label: '🏛️ Gov / Cheque', hBg: '#faf5ff', hTxt: '#9333ea', shDate: '#6b21a8', shPart: '#7e22ce', dBg: '#f3e8ff', dTxt: '#7e22ce', aBg: '#faf5ff', nTxt: '#581c87' },
