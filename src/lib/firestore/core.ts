...
export let attendanceCollection = collection(firestoreDB, ...getTenantCollectionPath("attendance"));
export let projectsCollection = collection(firestoreDB, ...getTenantCollectionPath("projects"));
export let employeesCollection = collection(firestoreDB, ...getTenantCollectionPath("employees"));
export let payrollCollection = collection(firestoreDB, ...getTenantCollectionPath("payroll"));
