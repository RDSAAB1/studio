...
const IDB_RESTORE_TABLES = new Set(["suppliers", "customers", "payments", "customerPayments", "loans", "fundTransactions", "bankAccounts", "banks", "bankBranches", "accounts", "kantaParchi", "customerDocuments", "supplierBankAccounts"]);
