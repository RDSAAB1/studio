        ...
        <div className="p-2 border rounded-lg bg-background flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-1 min-w-[120px]">
             ...
             <div className="flex gap-2">
                 <Button onClick={onGenerateClick} size="sm" className="h-8 text-xs"><Bot className="mr-2 h-4 w-4" />Generate</Button>
                 {paymentOptions.length > 0 && (
                    <Button onClick={() => setIsDialogOpen(true)} size="sm" variant="outline" className="h-8 text-xs">
                        <Replace className="mr-2 h-4 w-4" /> Change
                    </Button>
                )}
             </div>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="max-w-3xl">
                    <DialogHeader>
                        <DialogTitle>Generated Payment Combinations</DialogTitle>
                        <DialogDescription>Select an option to apply it to the payment form.</DialogDescription>
                    </DialogHeader>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {sortedPaymentOptions.length > 0 ? sortedPaymentOptions.map((option: any, index: number) => (
                                    ...
                                    <TableRow><TableCell colSpan={5} className="text-center text-muted-foreground text-xs h-24">No combinations generated. Adjust rates and click "Generate".</TableCell></TableRow>
                                )}
                            </TableBody>
                        </Table>
                    </ScrollArea>
