            ...
            <CardContent className="p-4 space-y-4">
                ...
                {/* Row 2: Supplier Details */}
                 <div className="space-y-3">
                    <h3 className="font-semibold text-sm flex items-center gap-2 text-muted-foreground"><InfoIcon className="h-4 w-4"/>Supplier Details</h3>
                ...
                {/* Row 3: Transaction Details */}
                 <div className="space-y-3">
                     <h3 className="font-semibold text-sm flex items-center gap-2 text-muted-foreground"><Truck className="h-4 w-4"/>Transaction Details</h3>
                ...
                <div className="space-y-3">
                     <h3 className="font-semibold text-sm flex items-center gap-2 text-muted-foreground"><Banknote className="h-4 w-4"/>Financial Details</h3>
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <div className="space-y-1">
