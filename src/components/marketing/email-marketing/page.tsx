  ...
  const handleSaveCampaign = async () => {
    ...
    try {
      if (currentCampaign?.id) {
        ...
        toast({ title: "Email campaign updated.", variant: "success" });
      } else {
        // Add new campaign
        ...
        toast({ title: "New email campaign added.", variant: "success" });
      }
  ...
  const handleDeleteCampaign = async (id: string) => {
    if (confirm("Are you sure you want to delete this campaign?")) {
      try {
        ...
        toast({ title: "Email campaign deleted.", variant: "success" });
      } catch (e) {
