                ...
                <div id="rtgs-receipt-content" className="p-6 bg-white text-black font-sans text-[12px] leading-normal flex flex-col justify-between min-h-[29.7cm] printable-area">
                    ...
                    <div className="flex-grow-0">
                        ...
                        <div className="border border-gray-200 p-3 rounded-lg mb-4">
                            <h3 className="font-bold text-gray-500 mb-2 uppercase tracking-wider text-xs" style={{ color: '#000' }}>Payee Details</h3>
                            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
                                <div><span className="font-semibold" style={{ color: '#000' }}>Name:</span> <span style={{ color: '#000' }}>{toTitleCase(payment.supplierName || '')}</span></div>
                                <div><span className="font-semibold" style={{ color: '#000' }}>S/O:</span> <span style={{ color: '#000' }}>{toTitleCase(payment.supplierFatherName || '')}</span></div>
                                <div className="col-span-2"><span className="font-semibold" style={{ color: '#000' }}>Address:</span> <span style={{ color: '#000' }}>{toTitleCase(payment.supplierAddress || '')}</span></div>
                            </div>
                        </div>
                            ...
                            <tbody>
                             ...
                             <tfoot>
                                <tr className="bg-gray-100 font-bold">
                                    <td className="p-2 text-right" colSpan={3} style={{ color: '#000' }}>TOTAL</td>
